...
def assert_response_with_expected_output(response, expected_output):
...
def test_get_moodle_grades_with_no_late_submission_policy_and_legal_excuses():
...
def test_get_moodle_grades_with_late_submission_policy_and_with_no_legal_excuses():
    moodle_result_data = MoodleResultsData(
        contest=Contest(
            id=1,
            name='test contest',
...
def test_get_moodle_grades_with_legal_excuses_and_late_submission_policy_case1():
    moodle_result_data = MoodleResultsData(
        contest=Contest(
            id=1,
            name='test contest',
