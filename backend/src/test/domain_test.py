...
def test_select_single_submission_for_each_participant_most_points():
    ...
    submissions: list[Submission] = [
        Submission(id=1, author=student1, verdict=Verdict.OK, passed_test_count=10, points=100.0,
                   programming_language="Python"),
        Submission(id=2, author=student1, verdict=Verdict.WRONG_ANSWER, passed_test_count=0, points=0.0,
                   programming_language="Python"),
        Submission(id=3, author=student1, verdict=Verdict.PARTIAL, passed_test_count=5, points=50.0,
                   programming_language="Python"),
        Submission(id=4, author=student2, verdict=Verdict.WRONG_ANSWER, passed_test_count=0, points=0.0,
                   programming_language="Python"),
        Submission(id=5, author=student2, verdict=Verdict.PARTIAL, passed_test_count=7, points=70.0,
                   programming_language="Python"),
    ]
    ...
    contest = Contest(id=1, name="Contest 1", start_time=datetime.now(), duration=timedelta(hours=2), problems=[problem])
